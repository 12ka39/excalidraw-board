...
const ChatWindow = ({ roomId, socket, nickname }) => {
  ...
  if (!isOpen) {
    return (
        <button
            ...
            className="fixed bottom-6 right-6 w-12 h-12 bg-purple-600 text-white rounded-full shadow-lg hover:bg-purple-700 transition-colors flex items-center justify-center z-50"
        >
  ...
  return (
      <div
          ...
          className={`fixed z-100 bg-purple-800 rounded-lg shadow-xl transition-all ${
